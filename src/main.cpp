...
int main(int, char **)
{
    ...
    // Our state
    bool done = false;
    bool is_text_open = true;
    bool is_edit_open = true;
...
#endif
    {
        ...
        if (is_text_open)
        {
            ImGui::Begin(u8"文本展示", &is_text_open);
            ImGui::Text(u8"中文测试");
            ImGui::End();
        }
        ...
        if (is_edit_open)
        {
            dms_editor::NodeEditorShow(u8"节点编辑", &is_edit_open);
        }
